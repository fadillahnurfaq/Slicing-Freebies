...
class MyVertialList extends StatelessWidget {
  final String courseImage, courseTittle, courseDuration;
  ...
  Widget build(BuildContext context) {
    return Padding(
      //* Memberikan jarak pada setiap item
      padding: const EdgeInsets.only(bottom: 8),
      //* Bagian pembungkus item
      child: SizedBox(
        height: 134,
        child: Stack(
